        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 48, paddingBottom: 40, borderBottom: '1px solid rgba(255,255,255,.08)', marginBottom: 28 }} className="footer-grid">
          ...
          <div>
            ...
            <nav style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              {[['/', 'footer.navigationLinks.home'],['/about','footer.navigationLinks.about'],['/services','footer.navigationLinks.services'],['/case-studies','footer.navigationLinks.caseStudies'],['/portfolio','footer.navigationLinks.portfolio'],['/intelligence','footer.navigationLinks.intelligence'],['/articles','footer.navigationLinks.articles'],['/contact','footer.navigationLinks.contact'],['/goglobal','footer.navigationLinks.goglobal'],['/agencies','footer.navigationLinks.agencies']].map(([to, labelKey]) => (
